...
document.onkeyup = function (data) {
    if (data.which == 27) {
        $("#transaction").empty();
        $.post('http://ld-banking/close', JSON.stringify({}));
...
$('.w-okay').click(function (e) {
    ...
    if (wvalue == "") {
        ...
        $.post('http://ld-banking/withdraw', JSON.stringify({
            value: wvalue,
            comment: wcomment
        })
        );
...
$('.d-okay').click(function (e) {
    ...
    if (dvalue == "") {
        ...
        $.post('http://ld-banking/deposit', JSON.stringify({
            value: dvalue,
            comment: dcomment
        })
        );
...
$('.t-okay').click(function (e) {
    ...
    if (tvalue == "" && tcomment =="") {
        ...
        $.post('http://ld-banking/transfer', JSON.stringify({
            value: tvalue,
            comment: tcomment,
            id: tid
        })
